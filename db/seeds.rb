...
tequila = Alcohol.create(etoh_name: "Tequila")
rye_whiskey = Alcohol.create(etoh_name: "Rye Whiskey")
dry_vermouth = Alcohol.create(etoh_name: "Dry Vermouth")
simple_syrup = Alcohol.create(etoh_name: "Simple Syrup")
